...
//-->
          ...
          <td width="1%"><a href="contacto.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('menu_07','','images/toolbar/menu_07_up.gif',1)"><img src="images/toolbar/menu_07.gif" name="menu_07" width="95" height="18" border="0"></a></td>
  ...
  <tr> 
    <td height="99%" valign="top" background="images/bg_02.jpg" bgcolor="#FFFFFF"> 
      <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td><img src="images/pixblanco.gif" width="15" height="35" border="0"></td>
          <td align="right" valign="bottom"><img name="index_r10_c6" src="images/index_r10_c6.gif" width="247" height="31" border="0" alt=""></td>
          <td valign="bottom"><img name="index_r10_c9" src="images/index_r10_c9.gif" width="17" height="31" border="0" alt=""></td>
          <td valign="bottom"><img name="index_r10_c11" src="images/index_r10_c11.gif" width="34" height="31" border="0" alt=""></td>
          <td><img src="images/pixblanco.gif" width="1" height="1" border="0"></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
          <td><img name="index_r11_c2" src="images/main/index_r11_c2.gif" width="389" height="177" border="0" alt=""></td>
          <td><img src="images/pixblanco.gif" width="1" height="1" border="0"></td>
          <td><img name="index_r11_c11" src="images/index_r11_c11.gif" width="34" height="177" border="0" alt=""></td>
          <td><img name="index_r11_c12" src="images/index_r11_c12.jpg" width="224" height="177" border="0" alt="Maquina CNC"></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
          <td><img name="index_r12_c2" src="images/index_r12_c2.gif" width="389" height="29" border="0" alt=""></td>
          <td><img name="index_r12_c9" src="images/index_r12_c9.gif" width="17" height="29" border="0" alt=""></td>
          <td><img name="index_r12_c11" src="images/index_r12_c11.gif" width="34" height="29" border="0" alt=""></td>
          <td><img name="index_r12_c12" src="images/index_r12_c12.gif" width="87" height="29" border="0" alt=""></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
          <td><img src="images/pixblanco.gif" width="1" height="1" border="0"></td>
          <td><img name="index_r13_c9" src="images/index_r13_c9.gif" width="17" height="67" border="0" alt=""></td>
          <td><img src="images/pixblanco.gif" width="1" height="1" border="0"></td>
          <td><img src="images/pixblanco.gif" width="1" height="1" border="0"></td>
        </tr>
      </table>
