<html>
<head>
<title>Fusion - Fashion - C&oacute;mo combinar</title>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="80%" valign="top" bgcolor="#FF6600"> 
      <?php include("../scripts/fashiontop.inc"); ?>
      <br>
      <table width="96%" border="0" align="center" cellpadding="4" cellspacing="0">
        <tr class="contenido3"> 
          <td width="99%" valign="top" bgcolor="#FF6600"><font color="#FFFFFF">qwo4finqweokfnlqwkn3lrkq23nm45nq2d34</font></td>
        </tr>
      </table>
    </td>
    <td width="10%" valign="top" background="images/back01.gif" bgcolor="#999966">&nbsp;</td>
  </tr>
</table>
